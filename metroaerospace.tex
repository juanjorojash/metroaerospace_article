...
\begin{figure*}[tbh]
    ...
    %SENSOR
    \draw[thick, gray,dashed] (7.5,1.5) -- (9,1.5)node[midway,below,align=center]{\large current\\ \large sensor} -- (9,-4) -- (7.5,-4) -- cycle;
    ...
    \draw[red] (mos3.G) |- (MCU);
    %%FILTER
    \draw[thick,gray,dashed] (12.5,1.5) -- (15,1.5)node[midway,below,align=center]{\large LC filter} -- (15,-4) -- (12.5,-4) -- cycle;
